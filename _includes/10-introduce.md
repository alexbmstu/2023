...
![Вычислительный комплекс Тераграф (вид спереди)](assets/teragraph_front.png)
...
![Вычислительный комплекс Тераграф (вид сзади)](assets/teragraph_back.png)
...
![Узел обработки графов](assets/teragraph_node.png)
...
![Структура гетерогенного узла обработки графов](assets/Teragraph_v2_rus.png)
...
![Структура микропроцессора Леонард Эйлер](assets/Leonhard_v4_1.png)
...
![Микроархитектура ядра обработки графов](assets/Graph_Processing_Core_v4_1.png)
